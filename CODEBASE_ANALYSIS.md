...
| Application source lines | Approximately 3,985 |
| Test files | 21 |
| Test lines | Approximately 2,103 |
| CLI commands | 13 |
| Runtime dependencies | PyMuPDF and PySide6 |
| Test result | 276 passed |
| Test runtime | 10.26 seconds |
...
than relying entirely on mocks. All 276 tests passed after Phase 7.
...
2. Implement and test the background operation worker bridge.
...
widget layer shared by all future operation forms. Native Linux and macOS
startup validation, command-line password secrecy, and the remaining
