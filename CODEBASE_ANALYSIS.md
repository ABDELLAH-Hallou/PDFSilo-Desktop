...
| Application source lines | Approximately 2,544 |
| Test files | 20 |
| Test lines | Approximately 1,596 |
| CLI commands | 13 |
| Runtime dependencies | PyMuPDF and PySide6 |
| Test result | 252 passed |
| Test runtime | 8.62 seconds |
...
than relying entirely on mocks. All 252 tests passed after Phase 5.
...
2. Create the PySide6 application structure and reusable worker bridge.
...
structure. Native Linux and macOS startup validation, command-line password
secrecy, and the remaining architectural improvements should be addressed as
the PySide6 migration progresses.
