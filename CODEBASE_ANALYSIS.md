...
| Application source lines | Approximately 3,040 |
| Test files | 20 |
| Test lines | Approximately 1,744 |
| CLI commands | 13 |
| Runtime dependencies | PyMuPDF and PySide6 |
| Test result | 258 passed |
| Test runtime | 10.06 seconds |
...
than relying entirely on mocks. All 258 tests passed after Phase 6.
...
2. Create reusable input widgets and the background worker bridge.
...
non-sensitive UI-state persistence. Native Linux and macOS startup validation,
command-line password secrecy, and the remaining architectural improvements
should be addressed as the PySide6 migration progresses.
