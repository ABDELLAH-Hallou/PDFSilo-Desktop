...
| Application source lines | Approximately 2,397 |
| Test files | 20 |
| Test lines | Approximately 1,522 |
| CLI commands | 13 |
| Runtime dependencies | PyMuPDF and PySide6 |
| Test result | 246 passed |
| Test runtime | 8.53 seconds |
...
than relying entirely on mocks. All 246 tests passed after Phase 4.
...
folder staging. Command-line password secrecy and the remaining architectural
