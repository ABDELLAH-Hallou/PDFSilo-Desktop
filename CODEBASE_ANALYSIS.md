...
| Application source lines | Approximately 7,329 |
| Test files | 24 |
| Test lines | Approximately 3,606 |
| CLI commands | 13 |
| Runtime dependencies | PyMuPDF and PySide6 |
| Test result | 313 passed |
| Test runtime | 30.31 seconds |
...
than relying entirely on mocks. All 313 tests passed after Phase 10.
...
1. Avoid command-line password arguments by adding secure interactive input.
2. Add complete folder-level transactional publication where appropriate.
3. Correct natural-DPI image placement.
4. Add dependency locking and CI.
5. Validate and package the application on native Windows, Linux, and macOS.
6. Add preview-aware page-range and rotation selection.
...
thumbnail-based page reordering. Native Linux and macOS startup validation,
