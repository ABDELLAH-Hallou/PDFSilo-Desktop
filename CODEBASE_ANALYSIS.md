...
| Application source lines | Approximately 6,207 |
| Test files | 23 |
| Test lines | Approximately 3,337 |
| CLI commands | 13 |
| Runtime dependencies | PyMuPDF and PySide6 |
| Test result | 304 passed |
| Test runtime | 34.93 seconds |
...
than relying entirely on mocks. All 304 tests passed after Phase 9.
...
4. Add PDF previews and thumbnail-based page selection.
5. Add dependency locking and CI.
6. Validate and package the application on native Windows, Linux, and macOS.
...
tests. Native Linux and macOS startup validation, command-line password
secrecy, previews, and the remaining architectural improvements should be
