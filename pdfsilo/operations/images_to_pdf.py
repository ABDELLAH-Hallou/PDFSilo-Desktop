...
Examples:
    pdfsilo images-to-pdf ./scans/
    pdfsilo images-to-pdf ./scans/ -o book.pdf --fit --margin 20
    pdfsilo images-to-pdf ./photos/ -s Letter -o album.pdf
"""
...
from pdfsilo.core.validation import require_directory
