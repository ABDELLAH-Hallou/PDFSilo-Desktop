...
Usage:
    python -m pdfsilo encrypt <input> [-p PASSWORD] [-o OUTPUT] [--owner-password PASSWORD]
...
Examples:
    ...
    pdfsilo encrypt contract.pdf

    # Full control: separate owner password, no copying allowed
    pdfsilo encrypt contract.pdf -p s3cr3t --owner-password adm1n --no-copy
"""
