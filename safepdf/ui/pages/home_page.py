"""Modern landing dashboard for the SafePDF application shell."""
...
from safepdf.ui.pages.registry import PAGE_DEFINITIONS
from safepdf.ui.theme import SPACE_LG, SPACE_MD, SPACE_SM, SPACE_XL
